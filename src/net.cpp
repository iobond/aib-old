...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "AIBond " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"seed.aibond.org","seed.aibond.com"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"seed.aibond.org","dnsseed.aibond.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. AIBond is probably already running."), addrBind.ToString().c_str());
        else
